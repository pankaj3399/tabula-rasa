...
const RecommendedTopics = () => {
  return (
    <div>
      ...
      <div className="border-t-2 border-red-500 pt-2 mb-3">
        <div className="border rounded-lg p-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <span className="text-sm">Valvular Heart Disease</span>
            </div>
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M9 18l6-6-6-6" />
            </svg>
          </div>
          <p className="text-gray-500 text-xs ml-6">Cardiovascular System • High-yield</p>
        </div>
      </div>
        ...
        <div className="border rounded-lg p-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <span className="text-sm">Pulmonary Neoplasms</span>
            </div>
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M9 18l6-6-6-6" />
            </svg>
          </div>
          <p className="text-gray-500 text-xs ml-6">Pulmonary System • Frequently tested</p>
        </div>
      </div>
    </div>
  );
