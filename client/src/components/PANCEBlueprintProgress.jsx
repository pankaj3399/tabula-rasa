...
const PANCEBlueprintProgress = () => {
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">PANCE Blueprint Progress</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="border rounded-lg p-4">
          <div className="flex items-center mb-2">
            ...
            <span className="text-gray-500">Cardiovascular System</span>
        ...
        <div className="border rounded-lg p-4">
          <div className="flex items-center mb-2">
            ...
            <span className="text-gray-500">Pulmonary System</span>
      ...
      <div className="text-center mt-4">
        <a href="#" className="text-purple-500 hover:text-purple-700">View All Systems →</a>
      </div>
    </div>
  );
};
